QUESTION_BANK = {
    "maths": [
        ...
        },
        {
            ...
            "a": "✅ Answer:Body language is non-verbal communication through posture, gestures, expressions, and eye contact.\n\nImportance:\n- Builds confidence\n- Shows interest\n- Improves personality impression\n\n✅ In interviews, body language matters a lot."
        }
    ],    "c": [
        {
        ...
        },
        {
            ...
            "a": "✅ Answer:Recursion is a function calling itself until a base condition is met.\n\nExample (factorial):\n\nint fact(int n)\n{\n    if(n == 0)\n        return 1;\n    else\n        return n * fact(n-1);\n}\n\n✅ Needs base condition to stop."
        },
        {
            "q": "What is an array? Explain with example",
            "a": "✅ Answer:Array is a collection of similar data items stored in continuous memory.\n\nExample:\nint a[5] = {10, 20, 30, 40, 50};\n\n✅ Access using index a[0], a[1], ..."
        },
        {
        ...
        },
        {
            ...
            "a": "✅ Answer:Function is a block of code that performs a specific task.\n\nSyntax:\nreturn_type function_name(parameters)\n{\n    // code\n    return value;\n}\n\nExample:\nint add(int a, int b)\n{\n    return a + b;\n}\n\n✅ Helps reuse and modular programming."
        }
    ]
}
